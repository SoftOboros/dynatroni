...
clear the leader key **for this cluster only**, then retry failover.
...
example, a `DYNATRONI_BREAK_GLASS=1` env var) to bypass the guard in emergencies.
Document this in your internal runbook.
